  ...
  },
{
    solutionId:'0004',
    label:'sleep',
    labels:['sleep','stress','occupation','nutrition','anxiety'],
    genderTag:['male', 'female', 'other'],
    ageTag:['<18','18-24','25-34','35-44','45-54','55-64','65+'],
    platform:['iOS'],
...
},
{
    solutionId:'0010',
    label:'sleep',
    labels:['sleep','stress','exercise','nutrition','social'],
    genderTag:['male','female','other'],
...
},
{
    solutionId:'0011',
    label:'sleep',
    labels:['occupation','stress','exercise','nutrition','social','anxiety','depression'],
    genderTag:['male','female','other'],
    ageTag: ['<18','18-24'],
    platform:['iOS' , 'Android'],
    title:'The Mix',
...
},
{
    solutionId:'0012',
    label:'sleep',
    labels:['occupation','exercise','social'],
    genderTag:['male','female','other'],
    ageTag:['<18','18-24','25-34','35-44','45-54','55-64','65+'],
    platform:['iOS' , 'Android'],
    title:'Goodgym',
...
},
{
    solutionId:'0014',
    label:'sleep',
    labels:['occupation','stress','exercise', 'nutrition'],
    genderTag:['male','female','other'],
    ageTag: ['<18','18-24','25-34','35-44','45-54','55-64','65+'],
    platform:['iOS' , 'Android'],
    title:'Live Happy',
...

{
    solutionId:'0016',
    label:'sleep',
    labels:['stress','anxiety','depression','social','occupation'],
    genderTag:['male','female','other'],
    ageTag: ['<18','18-24','25-34','35-44','45-54','55-64','65+'],
    platform:['iOS' , 'Android'],
    title:'Elefriends',
...

{
    solutionId:'0017',
    label:'sleep',
    labels:['stress','nutrition','depression','social','occupation'],
    genderTag:['male','female','other'],
    ageTag: ['18-24','25-34','35-44','45-54','55-64','65+'],
    platform:['iOS' , 'Android'],
    title:'Happify',
...
},
{
    solutionId:'0018',
    label:'sleep',
    labels:['stress','social','occupation','sleep','anxiety','depression'],
    genderTag:['male','female','other'],
    ageTag: ['<18', '18-24','25-34','35-44','45-54','55-64','65+'],
    platform:['iOS' , 'Android'],
    title:'HeadSpace',
...
},
{
    solutionId:'0021',
    label:'sleep',
    labels:['stress','nutrition','exercise'],
    genderTag:['female'],
