      ...
      <Container>
          ...
          <Grid columns={3} style={{paddingTop:75}}>
            ...
            <div className='directoryIcon directoryNotSelected' style={{ background: this.state.local}} >
              ...
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 88.93 90.76" style={{margin:'auto', height:35, marginTop:7, fill:'none', stroke:this.state.localSVG, strokeMiterlimit:10, strokeWidth:4}} >
                <g id="Layer_2" data-name="Layer 2">
                  <g id="Layer_1-2" data-name="Layer 1">
            ...
            <div className='directoryIcon directoryNotSelected' style={{ background: this.state.products}} >
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 81.5 106.75" style={{fill:'none', stroke:this.state.productsSVG, height:45}} >
                  <g id="Layer_2" data-name="Layer 2">
                    <g id="Layer_1-2" data-name="Layer 1">
                      <path style={{ strokeMiterlimit:10, strokeWidth:4}} d="M2.28,84.16c13.15,3.65,24.44,12,35.39,20.1A301.56,301.56,0,0,1,79.45,78.54L78,39.27Q64.75,48.12,50.83,55.9a14.57,14.57,0,0,1-6.15,2.28c-2.34.12-4.57-.86-6.72-1.78q-8.7-3.74-17.7-6.72C16.9,48.57,7.1,43.78,3.82,45.93c-3.09,2-1.3,14-1.34,17.46Z"/>
                      <path style={{strokeMiterlimit:10, strokeWidth:4}} d="M43,62.07c-2.88,12.49.56,26.06-3.84,38.1"/>

                      <path style={{strokeMiterlimit:10, strokeWidth:7}} d="M33.61,41.77c2.59,1.16,5.68.41,8.12-1s4.44-3.51,6.67-5.26c4.83-3.78,10.71-6.06,15.43-10a6.86,6.86,0,0,0,2.2-2.7,7.26,7.26,0,0,0,.19-3.36,51.47,51.47,0,0,0-2.14-10c-.56-1.75-1.3-3.58-2.81-4.63a8.38,8.38,0,0,0-4-1.16c-3.84-.37-7.94-.19-11.2,1.88s-5.27,5.88-6.7,9.58C36.67,22,36.56,29,34.83,36c-1.55,6.26-6,3.34-11.22,2.06a30.57,30.57,0,0,1-8.55-3c-2.6-1.56-4.8-4.09-5.21-7.1-.37-2.72,1.18-5.85,3.88-6.4,2.34-.48,4.58,1,6.48,2.46C24.48,27.2,28.68,30.7,31.92,35c1.85,2.46,2.3,3.83,1.87,4.5"/>

                      <path style={{strokeMiterlimit:10, strokeWidth:4}} d="M6.92,44.31A55.53,55.53,0,0,0,14.7,39"/>
                      <path style={{fill:'none', strokeMiterlimit:10, strokeWidth:4}} d="M78.18,37.6c-4.75-3.47-11.21-2.84-17-3.85"/>

                      <path style={{fill:'none', strokeMiterlimit:10, strokeWidth:7}} d="M19,90.55q1.09-17.71.51-35.48a6.23,6.23,0,0,1,.22-2.32A6,6,0,0,1,22.2,50.1a91.64,91.64,0,0,1,11.72-6.92c6.37,3,15.24,6,20.81,10.33a5.14,5.14,0,0,1,1.59,1.69,5.22,5.22,0,0,1,.4,1.7A295.73,295.73,0,0,1,58.65,89"/>
                      </g>
                    </g>
                </svg>
            </div>
