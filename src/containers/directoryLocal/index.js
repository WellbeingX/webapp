        ...
        <div style={{paddingTop:30}}>
            <div className='directoryFilterBar'>
              <p className="filterNormal">
                ...
                <span className="filterFilter">Filter</span> by <span className="filterHighlight">price</span>, <span className="filterHighlight">category</span> and <span className="filterHighlight">distance</span>
              </p>
            </div>
              <div className='recommendationContainer recommendationContainerMap'>
                <Map />
